<dl class="order-list-items">
  <dt class="order-list-items-title">
    <p class="order-list-cell-product">商品</p>
    <p class="order-list-cell-quantity">订单数量</p>
    <p class="order-list-cell-quantity">已发数量</p>
    <p class="order-list-cell-quantity">缺货数量</p>
    <p class="order-list-cell-price">单价金额</p>
    <p class="order-list-cell-total">总金额</p>
    <p class="order-list-cell-status">状态</p>
    <p class="order-list-cell-action">操作</p>
  </dt>
  <dd class="order-list-items-detail">
    ...
    <p class="order-list-cell-total"><strong>1000.00</strong></p>

    <p class="order-list-cell-status">已审核</p>

    <p class="order-list-cell-action">
  ...
  <dd class="order-list-items-detail">
    ...
    <div class="order-list-cell-detail">
      <div class="order-list-cell-single">
        <div class="order-list-cell-product">
          <a href="javascrtip:;"><img src="../src/images/temp/q4.jpg" alt=""></a>
          <p><a href="javascript:;">【清仓特价】威王洁厕至尊宝洁厕块 50g*10颗 超值套装</a></p>
          <span>SKU98334H22-0</span>
        </div>
        <p class="order-list-cell-quantity">10</p>
      ...
      <div class="order-list-cell-single">
        <div class="order-list-cell-product">
          <a href="javascrtip:;"><img src="../src/images/temp/q3.jpg" alt=""></a>
          <p><a href="javascript:;">【清仓特价】威王洁厕至尊宝洁厕块 50g*10颗 超值套装</a></p>
          <span>SKU98334H22-0</span>
        </div>
        <p class="order-list-cell-quantity">10</p>
